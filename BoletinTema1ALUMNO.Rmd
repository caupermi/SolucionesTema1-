...
uncommonAnimals1 <- setdiff(rownames(mammals), rownames(Animals2))
uncommonAnimals1

#  Animales en Animals2 pero no en mammals
uncommonAnimals2 <- setdiff(rownames(Animals2), rownames(mammals))
uncommonAnimals2
...
# En los dos dataframes se guardan animales igual con la diferencia de que no tiene el mismo nombre, es decir, en cada uno de los data frames el mismo animal tiene diferente nombre.
...
# Aparecen 192 librerias instaladas
